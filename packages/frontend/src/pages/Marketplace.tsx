...
import { Search, ShoppingBag, ChevronRight, Menu, X, Sparkles, TrendingUp, Shield } from 'lucide-react';
                ...
                <div className="fixed inset-0 bg-slate-900/50 z-[200] md:hidden backdrop-blur-sm" onClick={() => setIsMenuOpen(false)}>
                    <div className="absolute right-0 top-0 h-full w-4/5 max-w-xs bg-white p-5 shadow-2xl flex flex-col gap-5" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="flex flex-col gap-3">
                             ...
                             <button onClick={() => navigate('/register')} className="bg-emerald-600 py-3 rounded-xl font-semibold text-white text-sm hover:bg-emerald-700 transition-colors">Start Selling</button>
                        </div>
